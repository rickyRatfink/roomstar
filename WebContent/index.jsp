...
<table height="700" width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="mainBkgr">
		...
		<td width="100%" align="left" valign="top" class="mainBkgr" >
			<div id="boxContent"> 
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="right" valign="bottom" height="30" style="padding-right:30px">
						<input type="submit" name="action" value="Store" class="button"/>&nbsp;&nbsp;
					</td>
				</tr>
				</table>	
